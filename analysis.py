...
def main():
    ...
    # loan_amount_clusters = kmeans(extract_column(data, 0), num_clusters=10)
    ...
    # decision_tree_classifier(data, [3, 4, 9, 10, 11, 12, 19, 20, 21, 23, -1], 6, 8, random_state=0, print_confusion_matrix=True)
